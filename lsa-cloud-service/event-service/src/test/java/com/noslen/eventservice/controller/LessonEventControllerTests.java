...
@TestPropertySource(properties = {"spring.cloud.config.enabled=false", "spring.cloud.bootstrap.enabled=false", "eureka.client.enabled=false"})
@ActiveProfiles("test")
public class LessonEventControllerTests {
    ...
    LocalDateTime date1 = LocalDateTime.of(2033,
                                           Month.AUGUST,
                                           17,
                                           15,
                                           0);
    LocalDateTime date2 = LocalDateTime.of(2033,
                                           Month.AUGUST,
                                           17,
                                           15,
                                           30);
    LocalDateTime date3 = LocalDateTime.of(2033,
                                           Month.AUGUST,
                                           18,
                                           15,
                                           30);
    ...
    @BeforeEach
    void setUp() {
        lesson1 = new LessonEvent("testStudent",
                                  "teststudent@email.com",
                                  "testTeacher",
                                  "testteacher@email.com",
                                  date1,
                                  "Test");
        lesson2 = new LessonEvent("testStudent",
                                  "teststudent@email.com",
                                  "testTeacher",
                                  "testteacher@email.com",
                                  date2,
                                  "Test");
        lesson3 = new LessonEvent("testStudent",
                                  "teststudent@email.com",
                                  "testTeacher",
                                  "testteacher@email.com",
                                  date3,
    ...
    void shouldReturnLessonById() throws Exception {
        ...
        String formattedDateTime = lesson1.getDate()
                .format(formatter);
        mockMvc.perform(get("/api/lessons/1").with(jwt()))
                ...
                .andExpect(jsonPath("$.date").value(formattedDateTime))
    ...
    void shouldReturnLessonByStudent() throws Exception {
        ...
        mockMvc.perform(get("/api/lessons/student/testStudent").with(jwt()))
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].student").value(lesson1.getStudent()))
                .andExpect(jsonPath("$[1].student").value(lesson1.getStudent()));
    }
    ...
    void shouldReturnLessonByTeacher() throws Exception {
        ...
        mockMvc.perform(get("/api/lessons/teacher/testTeacher").with(jwt()))
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].teacher").value(lesson1.getTeacher()))
                .andExpect(jsonPath("$[1].teacher").value(lesson1.getTeacher()));
    }
